...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        playerMotionManaeger = CMMotionManager()
        playerMotionManaeger.accelerometerUpdateInterval = 0.02
    ...
    func startAccelerometer() {
        ...
        playerMotionManaeger.startAccelerometerUpdates(to: OperationQueue.main, withHandler: handler)
    }
    
    func gameCheck(result: String, message: String){
        
        if playerMotionManaeger.isAccelerometerActive {
            playerMotionManaeger.stopAccelerometerUpdates()
        }
